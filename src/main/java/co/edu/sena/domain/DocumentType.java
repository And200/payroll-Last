...
public class DocumentType implements Serializable {
    ...
    public void setEmployees(Set<Employee> employees) {
        if (this.employees != null) {
            this.employees.forEach(i -> i.setDocumentType(null));
        }
        if (employees != null) {
    ...
    public DocumentType employees(Set<Employee> employees) {
        this.setEmployees(employees);
        return this;
    }

    public DocumentType addEmployee(Employee employee) {
        this.employees.add(employee);
        employee.setDocumentType(this);
        return this;
    }

    public DocumentType removeEmployee(Employee employee) {
