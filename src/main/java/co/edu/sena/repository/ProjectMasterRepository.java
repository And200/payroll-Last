...
public interface ProjectMasterRepository extends JpaRepository<ProjectMaster, Long> {
    ...
    @Query(
        value = "select distinct projectMaster from ProjectMaster projectMaster left join fetch projectMaster.employee left join fetch projectMaster.costCenter",
    ...
    @Query(
        "select distinct projectMaster from ProjectMaster projectMaster left join fetch projectMaster.employee left join fetch projectMaster.costCenter"
    )
