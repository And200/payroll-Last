...
describe('Deduction Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call AccountPlan query and add missing value', () => {
      ...
      const accountPlan: IAccountPlan = { id: 51787 };
      deduction.accountPlan = accountPlan;
      ...
      const additionalAccountPlans = [accountPlan];
    ...
    it('Should update editForm', () => {
      const deduction: IDeduction = { id: 456 };
      const accountPlan: IAccountPlan = { id: 59626 };
      deduction.accountPlan = accountPlan;
      ...
      expect(comp.accountPlansSharedCollection).toContain(accountPlan);
    });
  });
