...
class AccountPlanResourceIT {
    ...
    public static AccountPlan createEntity(EntityManager em) {
        AccountPlan accountPlan = new AccountPlan().description(DEFAULT_DESCRIPTION);
        return accountPlan;
    }
    ...
    public static AccountPlan createUpdatedEntity(EntityManager em) {
        AccountPlan accountPlan = new AccountPlan().description(UPDATED_DESCRIPTION);
        return accountPlan;
    }
    ...
    void createAccountPlan() throws Exception {
        ...
        restAccountPlanMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(accountPlanDTO))
            )
    ...
    void putNewAccountPlan() throws Exception {
        ...
        updatedAccountPlan.description(UPDATED_DESCRIPTION);
        ...
        restAccountPlanMockMvc
            .perform(
                put(ENTITY_API_URL_ID, accountPlanDTO.getId())
                    ...
                    .content(TestUtil.convertObjectToJsonBytes(accountPlanDTO))
            )
            .andExpect(status().isOk());
    ...
    void putWithMissingIdPathParamAccountPlan() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAccountPlanMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(accountPlanDTO)))
    ...
    void patchWithMissingIdPathParamAccountPlan() throws Exception {
        ...
        restAccountPlanMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(accountPlanDTO))
            )
            .andExpect(status().isMethodNotAllowed());
