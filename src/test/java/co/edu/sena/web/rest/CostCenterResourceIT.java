...
class CostCenterResourceIT {
    ...
    public static CostCenter createEntity(EntityManager em) {
        CostCenter costCenter = new CostCenter().costCenterName(DEFAULT_COST_CENTER_NAME).costCenterType(DEFAULT_COST_CENTER_TYPE);
        return costCenter;
    }
    ...
    public static CostCenter createUpdatedEntity(EntityManager em) {
        CostCenter costCenter = new CostCenter().costCenterName(UPDATED_COST_CENTER_NAME).costCenterType(UPDATED_COST_CENTER_TYPE);
        return costCenter;
    }
    ...
    void putNewCostCenter() throws Exception {
        ...
        updatedCostCenter.costCenterName(UPDATED_COST_CENTER_NAME).costCenterType(UPDATED_COST_CENTER_TYPE);
    ...
    void fullUpdateCostCenterWithPatch() throws Exception {
        ...
        partialUpdatedCostCenter.costCenterName(UPDATED_COST_CENTER_NAME).costCenterType(UPDATED_COST_CENTER_TYPE);
