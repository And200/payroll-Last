...
class OperatorMatrizResourceIT {
    ...
    void createOperatorMatriz() throws Exception {
        ...
        OperatorMatrizDTO operatorMatrizDTO = operatorMatrizMapper.toDto(operatorMatriz);
        restOperatorMatrizMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(operatorMatrizDTO))
            )
    ...
    void putNewOperatorMatriz() throws Exception {
        ...
        updatedOperatorMatriz.name(UPDATED_NAME).address(UPDATED_ADDRESS).city(UPDATED_CITY).email(UPDATED_EMAIL);
        OperatorMatrizDTO operatorMatrizDTO = operatorMatrizMapper.toDto(updatedOperatorMatriz);

        restOperatorMatrizMockMvc
            .perform(
                put(ENTITY_API_URL_ID, operatorMatrizDTO.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(operatorMatrizDTO))
            )
            .andExpect(status().isOk());
    ...
    void putWithMissingIdPathParamOperatorMatriz() throws Exception {
        ...
        restOperatorMatrizMockMvc
            .perform(
                put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(operatorMatrizDTO))
            )
    ...
    void fullUpdateOperatorMatrizWithPatch() throws Exception {
        ...
        partialUpdatedOperatorMatriz.name(UPDATED_NAME).address(UPDATED_ADDRESS).city(UPDATED_CITY).email(UPDATED_EMAIL);
    ...
    void patchNonExistingOperatorMatriz() throws Exception {
        ...
        restOperatorMatrizMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, operatorMatrizDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(operatorMatrizDTO))
            )
            .andExpect(status().isBadRequest());
