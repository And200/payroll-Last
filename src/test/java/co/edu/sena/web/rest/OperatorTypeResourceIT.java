...
class OperatorTypeResourceIT {
    ...
    public static OperatorType createEntity(EntityManager em) {
        OperatorType operatorType = new OperatorType().description(DEFAULT_DESCRIPTION);
        return operatorType;
    }
    ...
    public static OperatorType createUpdatedEntity(EntityManager em) {
        OperatorType operatorType = new OperatorType().description(UPDATED_DESCRIPTION);
        return operatorType;
    }
    ...
    void createOperatorType() throws Exception {
        ...
        restOperatorTypeMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(operatorTypeDTO))
            )
    ...
    void putNewOperatorType() throws Exception {
        ...
        updatedOperatorType.description(UPDATED_DESCRIPTION);
        OperatorTypeDTO operatorTypeDTO = operatorTypeMapper.toDto(updatedOperatorType);

        restOperatorTypeMockMvc
            .perform(
                put(ENTITY_API_URL_ID, operatorTypeDTO.getId())
    ...
    void putWithMissingIdPathParamOperatorType() throws Exception {
        ...
        restOperatorTypeMockMvc
            .perform(
                put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(operatorTypeDTO))
            )
    ...
    void patchNonExistingOperatorType() throws Exception {
        ...
        restOperatorTypeMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, operatorTypeDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(operatorTypeDTO))
            )
            .andExpect(status().isBadRequest());
