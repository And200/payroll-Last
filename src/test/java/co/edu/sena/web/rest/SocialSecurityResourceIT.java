...
class SocialSecurityResourceIT {
    ...
    void createSocialSecurity() throws Exception {
        ...
        SocialSecurityDTO socialSecurityDTO = socialSecurityMapper.toDto(socialSecurity);
        restSocialSecurityMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(socialSecurityDTO))
            )
    ...
    void putNewSocialSecurity() throws Exception {
        ...
        SocialSecurityDTO socialSecurityDTO = socialSecurityMapper.toDto(updatedSocialSecurity);

        restSocialSecurityMockMvc
            .perform(
                put(ENTITY_API_URL_ID, socialSecurityDTO.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(socialSecurityDTO))
            )
            .andExpect(status().isOk());
    ...
    void putWithMissingIdPathParamSocialSecurity() throws Exception {
        ...
        restSocialSecurityMockMvc
            .perform(
                put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(socialSecurityDTO))
            )
    ...
    void patchNonExistingSocialSecurity() throws Exception {
        ...
        restSocialSecurityMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, socialSecurityDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(socialSecurityDTO))
            )
            .andExpect(status().isBadRequest());
